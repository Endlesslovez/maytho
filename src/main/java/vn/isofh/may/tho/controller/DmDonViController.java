...
import vn.isofh.may.tho.service.DmDonViService;

@RestController
@RequestMapping(path = "/dm-don-vi")
public class DmDonViController extends BaseController<DmDonViDTO, DmDonViService> {

  @Autowired
  private DmDonViService service;

  @Override
  protected DmDonViService getService() {
    return service;
  }
  ...
  @GetMapping("/excel")
  @Transactional
  public ResponseEntity<InputStreamResource> export(DmDonViDTO dto, Pageable pageable) {
    return responseAttachment(service.export(dto, pageable));
  }
}
