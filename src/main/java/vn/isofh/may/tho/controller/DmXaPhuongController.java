...
import vn.isofh.may.tho.service.DmXaPhuongService;

@RestController
@RequestMapping(path = "/dm-xa-phuong")
public class DmXaPhuongController extends BaseController<DmXaPhuongDTO, DmXaPhuongService> {

  @Autowired
  private DmXaPhuongService service;

  @Override
  protected DmXaPhuongService getService() {
    return service;
  }
